...
INCLUDE_ASM("st/rlib/nonmatchings/e_collect", PrizeDropFall);

INCLUDE_ASM("st/rlib/nonmatchings/e_collect", PrizeDropFall2);

INCLUDE_ASM("st/rlib/nonmatchings/e_collect", CollectHeart);

INCLUDE_ASM("st/rlib/nonmatchings/e_collect", CollectGold);

INCLUDE_ASM("st/rlib/nonmatchings/e_collect", CollectSubweapon);

INCLUDE_ASM("st/rlib/nonmatchings/e_collect", CollectHeartVessel);
...
INCLUDE_ASM("st/rlib/nonmatchings/e_collect", EntityExplosion);

INCLUDE_ASM("st/rlib/nonmatchings/e_collect", BlinkItem);
...
INCLUDE_ASM("st/rlib/nonmatchings/e_collect", EntityHeartDrop);
